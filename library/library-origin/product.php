...
?>
    ...
    <div class="breadcrumb-section breadcrumb-bg">
        ...
        <!-- start product -->
        <div class="product-section col-lg-12">
            <div class="container mt-100" id="search">
                        ...
                        <div class="col-lg-4 col-md-6 text-center strawberry">
                            <div class="single-product-item">
                                <div class="product-image">
                                        ...
                                        <img src="images/<?php echo $product['url_image'] ?>" alt="" height="280px"></a>
                                </div>
                                <h3><?php echo $product['product_name'] ?></h3> 
                                <p class="product-price"><h6><?php echo '$'.$product['price'] ?></h6></p>
