		...
		<div class="row">
			<div class="col-lg-8 offset-lg-2 text-center">
				<div class="section-title">
					...
					<p>Our library contains four main categories, characterized by the latest products and the most suitable prices 📚✏️ </p>
				</div>
			</div>
		</div>
		<div class="row">
	...
	<div class="row">
		<div class="col-lg-8 offset-lg-2 text-center">
			<div class="section-title">
				...
				<p>Users' opinions about shopping at Besnm Bookstore and whether
				 he/she had a great experience and got the product he/she was looking for in our library 📚✏️</p>
			</div>
		</div>
	</div>
